...
(function (document, window)
{
    ...
    var impress = window.impress = function (rootId)
    {
        ...
        var init = function (flag)
        {
            ...
            {
                //即时编辑使用修正功能
                var impressCanvasHTML = document.getElementById("impressCanvas").innerHTML;
                //root.removeChild(document.getElementById("impressCanvas"));
                //document.getElementById("impressCanvas").remove();
                /*
                (function(id){
                    var element = document.getElementById("impressCanvas").remove();
                    element.outerHTML = "";
                })("impressCanvas");*/
                console.log(root);

                document.getElementById("temp").innerHTML = impressCanvasHTML;
                var subp = document.getElementById("temp").childNodes;
                console.log(subp);
                for (var i = subp.length - 1; i >= 0; i--)
                {
                    //console.log(subp[i]);
                    try
                    {
                        if (subp[i].hasAttribute("style"))
                        {
                            subp[i].removeAttribute("style");
                        };
                    }
                    catch (e)
                    {
                ...
                console.log(root);
                console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
                root.appendChild(subp);

                console.log("ne revise!");
                canvas = document.createElement("div");
                canvas.id = "impressCanvas";

                //canvas.innerHTML = impressCanvasHTML;
                //var pages = canvas.childNodes;
            };
